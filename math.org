...
math: {{c1::Natural Numbers}} = {{c2::0, 1, 2, ... or 1, 2, ...::X or Y}}
...
:PROPERTIES:
:ANKI_NOTE_TYPE: Cloze
:ANKI_NOTE_ID: 1626525420558
:END:

**** Text

math: In a/b, a is the {{c1::Numerator or Dividend::XXX or XXX}} and b is the
{{c2::Denominator or Divisor::XXX or XXX}}
...
math: A {{c1::Mixed Number}} is noted as {{c2::a b/c}}
...
math: a/b is an Irreducible Fraction if {{c1::gcd(a, b) = 1}}
...
math: An {{c1::Interval Notation}} is written as {{c2::[X, Y] when X and Y are included or (X, Y) if not}}
...
math: {{c1::Parallel}} lines have {{c2::the same slope::XXX slope}}
...
The degree of a Polynomial Term is {{c1::the sum of the exponents of its variables}}
...
math: {{c1::sqrt(a/b)}} = {{c2::sqrt(a)/sqrt(b)}}
...
- {{c1::minimum value of the equation if the parabola opens upward}}
- {{c1::maximum value of the equation if the parabola opens downward}}
