...
:DRILL_EASE: 2.08
:DRILL_LAST_QUALITY: 3
:DRILL_LAST_REVIEWED: [2020-09-01 Tue 12:27]
:END:
...
math: <[An equation that is true for some values of the variable (eg. 2 x = 4)]> is a <[Conditional Equation]>
...
math: <[An equation that is true for any value of the variable (eg. x + 3 = x + 3)]> is <[an Identity Equation]>
...
math: <[An equation that is false for all values of the variable (eg. x = x + 1)]> is <[a Contradiction Equation]>
