...
:DRILL_EASE: 1.48
:DRILL_LAST_QUALITY: 4
:DRILL_LAST_REVIEWED: [2020-11-22 Sun 11:25]
:END:
...
:DRILL_EASE: 2.36
:DRILL_LAST_QUALITY: 3
:DRILL_LAST_REVIEWED: [2020-11-22 Sun 11:42]
:END:
...
:DRILL_EASE: 2.32
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-11-22 Sun 11:24]
:END:
...
<[
\begin{gather*}
\text{For the y-intercept, let x = 0 an solve for y} \\
y = 0^2 - 2*0 - 8 = -8 \\
\text{y-intercept: (0, -8)} \\
\\
\text{For the x-intercept, let y = 0 an solve for x} \\
0 = x^2 - 2x - 8 \\
0 = (x - 4)(x + 2) \\
x = 4, x = -2 \\
