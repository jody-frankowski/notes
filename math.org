...
math: The <[Least Common Multiple (lcm) of a and b]> is <[the smallest number that is divisible by
both a and b]>
...
math: Use <[the lcm of the denominators]> to merge the sum of two fractions
...
math: The <[Greatest Common Divisor (gcd) of a and b]> is <[the greatest number that divides both
a and b]>
...
math: You can use <[the gcm of the numerator and denominator]> to reduce a fraction

*** Irreducible Fraction                                            :drill:
:PROPERTIES:
:END:

math: <[An Irreducible Fraction]> is a fraction whose numerator and denominator have no common
factors
