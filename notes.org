...
linux: fs: Files *Capabilities* are implemented {{c1::through the use of Extended File Attributes}}
...
cmd: gnu: {{c1::dircolors}} is the command that generates the {{c2::LS_COLORS
variable for ls}}
